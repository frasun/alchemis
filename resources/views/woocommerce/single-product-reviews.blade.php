...
?>
<div id="reviews" class="woocommerce-Reviews not-prose py-5">
  <div id="comments">
    <header class="flex text-green items-center mb-5">
      ...
      <h2 class="woocommerce-Reviews-title m-0 mt-0.25 text-xl">
        <?php
    ...
    <ol class="commentlist">
      <?php wp_list_comments(apply_filters('woocommerce_product_review_list_args', ['callback' => 'woocommerce_comments', 'reverse_top_level' => true])); ?>
    </ol>
